...
try:
  ...
  inData = requests.get('http://thecore:8080/json.htm?type=devices&rid=' + INDOOR_THERMO_ID).json()['result'][0]
  outData = requests.get('http://thecore:8080/json.htm?type=devices&rid=' + OUTDOOR_THERMO_ID).json()['result'][0]
